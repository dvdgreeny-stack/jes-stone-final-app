...
export const translations = {
  en: {
    ...
    serviceNeededLabel: "Services Needed (Select all that apply)",
    otherServicesLabel: "Other Services / Details",
    ...
    otherServicePlaceholder: "Describe any other specific needs...",
  ...
  es: {
    ...
    serviceNeededLabel: "Servicios Necesarios (Seleccione Varios)",
    otherServicesLabel: "Otros Servicios / Detalles",
    ...
    otherServicePlaceholder: "Describa otras necesidades específicas...",
